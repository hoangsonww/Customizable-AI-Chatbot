...
This document describes the security vulnerability disclosure process for the **AI Assistant Template** project. It covers supported versions, reporting guidelines, response commitments, and safe-harbor protections for security researchers.
...
—you will not face legal action from the AI Assistant Template team.
